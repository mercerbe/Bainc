          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <div className="form-group">
                  <input type="password" className="form-control form-control-lg" placeholder="Confirm Password" name="passwordCheck" value={this.state.passwordCheck} onChange={this.onChange} />
                </div>
